					...
					<div class="info_box" style="height: 270px;">
						<div class="text">
							...
							<div class="btns" style="height: 45px;">
								...
								<div class="button" >
									<a href="/home/practice/selectQuestionType?category=<?php echo ($category); ?>&chapter=1" rel="">第1章</a>
								</div>
								<div class="button">
									<a href="/home/practice/selectQuestionType?category=<?php echo ($category); ?>&chapter=2" rel="">第2章</a>
								</div>
								<div class="button">
									<a href="/home/practice/selectQuestionType?category=<?php echo ($category); ?>&chapter=3" rel="">第3章</a>
								</div>
								
							</div>	
							<div class="btns" style="margin-top: 10px;height: 45px;">
					
								<div class="button" >
									<a href="/home/practice/selectQuestionType?category=<?php echo ($category); ?>&chapter=4" rel="">第4章</a>
								</div>
								<div class="button">
									<a href="/home/practice/selectQuestionType?category=<?php echo ($category); ?>&chapter=5" rel="">第5章</a>
								</div>
								<div class="button">
									<a href="/home/practice/selectQuestionType?category=<?php echo ($category); ?>&chapter=6" rel="">第6章</a>
								</div>
